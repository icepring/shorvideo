package com.tym.shortvideo.core;

import android.os.Handler;
import android.os.Message;

import com.tym.shortvideo.tymtest.AccurateCountDownTimer;
...
public final class CountDownManager {
    ...
    private long mMinMillisSeconds = VideoListManager.DURATION_THREE_SECOND;
    // 50毫秒读取一次
