...
public class GLNostalgiaFilter extends GLImageFilter {
    ...
    private int mWidthOffsetLoc;
    private int mHeightOffsetLoc;
    private int mBlurSizeLoc;

    public GLNostalgiaFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLNostalgiaFilter(String vertexShader, String fragmentShader) {
        ...
        mWidthOffsetLoc = GLES30.glGetUniformLocation(mProgramHandle, "texelWidthOffset");
        mHeightOffsetLoc = GLES30.glGetUniformLocation(mProgramHandle, "texelHeightOffset");
    ...
    private void createTexture1() {
        ...
        mCurveTexture1 = GlUtil.createTexture(arrayOfByte, 256, 1);
    }
    ...
    public void onInputSizeChanged(int width, int height) {
        ...
        setFloat(mWidthOffsetLoc, 1.0f / mImageWidth);
        setFloat(mHeightOffsetLoc, 1.0f / mImageHeight);
        setFloat(mBlurSizeLoc, 1.0f);
