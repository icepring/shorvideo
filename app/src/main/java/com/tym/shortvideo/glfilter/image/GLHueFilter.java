...
public class GLHueFilter extends GLImageFilter {
    ...
    public GLHueFilter(String vertexShader, String fragmentShader) {
        super(vertexShader, fragmentShader);
        mHueAdjustLoc = GLES30.glGetUniformLocation(mProgramHandle, "hueAdjust");
        setHue(0);
    }
    ...
    public void setHue(float hue) {
        ...
        setFloat(mHueAdjustLoc, hueAdjust);
    }
}
