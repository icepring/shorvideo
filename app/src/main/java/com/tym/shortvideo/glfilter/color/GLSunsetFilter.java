...
public class GLSunsetFilter extends GLImageFilter {
    ...
    public GLSunsetFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLSunsetFilter(String vertexShader, String fragmentShader) {
    ...
    private void createTexture() {
        ...
        mCurveTexture = GlUtil.createTexture(arrayOfByte, 256, 2);
    ...
    public void onDrawArraysBegin() {
        ...
        GLES30.glUniform1i(mMaskTexture1Loc, 3);
    }
