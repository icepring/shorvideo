...
public class GLBrooklynFilter extends GLImageFilter {
    ...
    private int mCurveTexture1Loc;

    public GLBrooklynFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLBrooklynFilter(String vertexShader, String fragmentShader) {
        ...
        mCurveTexture1Loc = GLES30.glGetUniformLocation(mProgramHandle, "curveTexture1");
        createTexture();
    ...
    private void createTexture() {
        ...
        mCurveTexture1 = GlUtil.createTextureFromAssets(ParamsManager.context,
    ...
    public void onDrawArraysBegin() {
        ...
        GLES30.glUniform1i(mCurveTexture1Loc, 3);
