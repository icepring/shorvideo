...
public class GLHealthyFilter extends GLImageFilter {
    ...
    public GLHealthyFilter() {
        this(VERTEX_SHADER, FRAGMENT_SHADER);
    }

    public GLHealthyFilter(String vertexShader, String fragmentShader) {
        super(vertexShader, fragmentShader);

        mCurveTextureLoc = GLES30.glGetUniformLocation(mProgramHandle, "curveTexture");
        mMaskTextureLoc = GLES30.glGetUniformLocation(mProgramHandle, "maskTexture");
        mTexelWidthOffsetLoc = GLES30.glGetUniformLocation(mProgramHandle, "texelWidthOffset");
        mTexelHeightOffsetLoc = GLES30.glGetUniformLocation(mProgramHandle, "texelHeightOffset");
        createTexture();
    }
    ...
    private void createTexture() {
        ...
        mCurveTexture = GlUtil.createTexture(arrayOfByte, 256, 1);
        mMaskTexture = GlUtil.createTextureFromAssets(ParamsManager.context,
    ...
    public void onInputSizeChanged(int width, int height) {
        ...
        setFloat(mTexelWidthOffsetLoc, 1.0f / mImageWidth);
        setFloat(mTexelHeightOffsetLoc, 1.0f/ mImageHeight);
    }
    ...
    public void onDrawArraysBegin() {
        ...
        GLES30.glUniform1i(mMaskTextureLoc, 2);
    }
