...
public class MagicSkinWhitenFilter extends GPUImageFilter {
    ...
    public MagicSkinWhitenFilter() {
    	super(R.raw.skinwhiten);
    }
    
    @Override
    public void onInit() {
        super.onInit();
        mToneCurveTextureUniformLocation = GLES30.glGetUniformLocation(getProgram(), "curve");
    ...
    public void onInputSizeChanged(int width, int height) {
        ...
        GLES30.glUniform1f(mTexelWidthUniformLocation, (1.0f / (float)width));
        GLES30.glUniform1f(mTexelHeightUniformLocation, (1.0f / (float)height));
    }
