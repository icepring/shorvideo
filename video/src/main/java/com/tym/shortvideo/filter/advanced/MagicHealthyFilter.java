...
public class MagicHealthyFilter extends GPUImageFilter {
	...
	protected void onInit(){
        ...
        mMaskGrey1UniformLocation = GLES30.glGetUniformLocation(getProgram(), "mask");
        mTexelWidthUniformLocation = GLES30.glGetUniformLocation(getProgram(), "texelWidthOffset");
        mTexelHeightUniformLocation = GLES30.glGetUniformLocation(getProgram(), "texelHeightOffset");
	}
	...
	protected void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
			...
			public void run(){
		        ...
		        mMaskGrey1TextureId = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/healthy_mask_1.jpg");
		    }
	    });
	}
	...
	public void onInputSizeChanged(int width, int height){
	    ...
	    GLES30.glUniform1f(mTexelWidthUniformLocation, 1.0f / width);
	    GLES30.glUniform1f(mTexelHeightUniformLocation, 1.0f / height);
	}
}
