...
public class MagicValenciaFilter extends GPUImageFilter {
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
		    @Override
			public void run(){
		    	inputTextureHandles[0] = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/valenciamap.png");
				inputTextureHandles[1] = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/valenciagradientmap.png");
		    }
	    });
	}
}
