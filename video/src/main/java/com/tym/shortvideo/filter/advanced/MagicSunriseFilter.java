...
public class MagicSunriseFilter extends GPUImageFilter {
    ...
    protected void onDestroy() {
        ...
        GLES30.glDeleteTextures(1, new int[]{mMaskGrey1TextureId}, 0);
        mMaskGrey1TextureId = -1;
        GLES30.glDeleteTextures(1, new int[]{mMaskGrey2TextureId}, 0);
        mMaskGrey2TextureId = -1;
        GLES30.glDeleteTextures(1, new int[]{mMaskGrey3TextureId}, 0);
    ...
    protected void onDrawArraysPre() {
        ...
        if (mMaskGrey3TextureId != -1) {
            GLES30.glActiveTexture(GLES30.GL_TEXTURE6);
            GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, mMaskGrey3TextureId);
            GLES30.glUniform1i(mMaskGrey3UniformLocation, 6);
        }
    }
    ...
    protected void onInit() {
        ...
        mMaskGrey3UniformLocation = GLES30.glGetUniformLocation(getProgram(), "grey3Frame");
    }
