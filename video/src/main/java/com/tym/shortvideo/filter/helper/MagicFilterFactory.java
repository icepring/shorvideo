...
public class MagicFilterFactory {
    ...
    private static List<MagicFilterType> sTypeList;
    public static List<MagicFilterType> getFilterTypes() {
        if (sTypeList == null) {
            sTypeList = new ArrayList<>();
        }
        if (sTypeList.isEmpty()) {
            sTypeList.add(MagicFilterType.NONE);
            sTypeList.add(MagicFilterType.FAIRYTALE);
            sTypeList.add(MagicFilterType.SUNRISE);
            sTypeList.add(MagicFilterType.SUNSET);
        }
        return sTypeList;
    }
