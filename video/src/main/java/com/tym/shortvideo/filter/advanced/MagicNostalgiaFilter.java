...
public class MagicNostalgiaFilter extends GPUImageFilter {
	...
	public void onDestroy(){
	    ...
	    GLES30.glDeleteTextures(1, mToneCurveTexture2, 0);
	...
	protected void onDrawArraysPre(){
		...
		if (mToneCurveTexture2[0] != -1){
			GLES30.glActiveTexture(GLES30.GL_TEXTURE4);
			GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, mToneCurveTexture[0]);
			GLES30.glUniform1i(mToneCurveTextureUniformLocation2, 4);
	    }
		GLES30.glUniform1f(mBlurSizeUniformLocation, 1.0F);
	}
	...
	public void onInit(){
        ...
        mToneCurveTextureUniformLocation2 = GLES30.glGetUniformLocation(mGLProgId, "curve2");
        ...
        mBlurSizeUniformLocation = GLES30.glGetUniformLocation(getProgram(), "blurSize");
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
			...
			public void run(){
		        ...
		        GLES30.glTexImage2D(GLES30.GL_TEXTURE_2D, 0, GLES30.GL_RGBA, 256, 2, 0, GLES30.GL_RGBA, GLES30.GL_UNSIGNED_BYTE, ByteBuffer.wrap(arrayOfByte1));
		        GLES30.glGenTextures(1, mToneCurveTexture2, 0);
			    GLES30.glBindTexture(GLES30.GL_TEXTURE_2D, mToneCurveTexture2[0]);
			    GLES30.glTexParameterf(GLES30.GL_TEXTURE_2D,
		                GLES30.GL_TEXTURE_MAG_FILTER, GLES30.GL_LINEAR);
		        GLES30.glTexParameterf(GLES30.GL_TEXTURE_2D,
		                GLES30.GL_TEXTURE_MIN_FILTER, GLES30.GL_LINEAR);
		        ...
		        GLES30.glTexImage2D(GLES30.GL_TEXTURE_2D, 0, GLES30.GL_RGBA, 256, 1, 0, GLES30.GL_RGBA, GLES30.GL_UNSIGNED_BYTE, ByteBuffer.wrap(arrayOfByte2));
		    }
	    });
	}
