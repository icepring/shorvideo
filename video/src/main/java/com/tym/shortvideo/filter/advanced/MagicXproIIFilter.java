...
public class MagicXproIIFilter extends GPUImageFilter {
	...
	public MagicXproIIFilter(){
		super(R.raw.xproii_filter_shader);
	}
	...
	public void onInitialized(){
		...
		runOnDraw(new Runnable(){
			@Override
			public void run(){
				inputTextureHandles[0] = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/xpromap.png");
				inputTextureHandles[1] = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/vignettemap_new.png");
			}
		});
	}
