...
public class MagicSweetsFilter extends GPUImageFilter {
    ...
    protected void onDestroy() {
        super.onDestroy();
        GLES30.glDeleteTextures(2, new int[]{mToneCurveTexture[0], mMaskGrey1TextureId}, 0);
    ...
    protected void onInit() {
        ...
        mLowPerformanceUniformLocation = GLES30.glGetUniformLocation(getProgram(), "lowPerformance");
    ...
    protected void onInitialized() {
        ...
        runOnDraw(new Runnable() {
            public void run() {
                ...
                mMaskGrey1TextureId = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/rise_mask2.jpg");
            }
        });
    }
}
