...
public class MagicWarmFilter extends GPUImageFilter {
	...
	public void onInit(){
        ...
        mMaskGrey1UniformLocation = GLES30.glGetUniformLocation(getProgram(), "layerImage");
        mMaskGrey2UniformLocation = GLES30.glGetUniformLocation(getProgram(), "greyFrame");
	}
	...
	public void onInitialized(){
	    ...
	    runOnDraw(new Runnable(){
			...
			public void run(){
		        ...
		        mMaskGrey1TextureId = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/warm_layer1.jpg");
		        mMaskGrey2TextureId = GlUtil.createTextureFromAssets(ParamsManager.context, "filter/bluevintage_mask1.jpg");
		    }
	    });
	}
}
