...
public class RangeSeekBarView extends View {
    ...
    private static final int paddingTop = DeviceUtils.dipToPX(15);
    private static final int TextPostionX = DeviceUtils.dipToPX(10);
    private static final int deviceWidth = DeviceUtils.getScreenWidth() - DeviceUtils.dipToPX(12);
    ...
    private int shadowMargin = DeviceUtils.dipToPX(5);
    ...
    private int drawTop = DeviceUtils.dipToPX(6);
    ...
    private int textPosMargin = DeviceUtils.dipToPX(6);
